...
public:
    ...
    {
        return m_nMaxHistoryItems;    //+++hd
    }
    void	SetCheckAccess ( BOOL bCheckAccess )
    {
        m_bCheckAccess = bCheckAccess;    //+++hd
    }
    BOOL	GetCheckAccess()
    {
        return m_bCheckAccess;    //+++hd
    }
    void	SetDropSize ( int nDropSize )
    {
        m_nDropSize = nDropSize;    //+++hd
    }
    int		GetDropSize()
    {
        return m_nDropSize;    //+++hd
    }
